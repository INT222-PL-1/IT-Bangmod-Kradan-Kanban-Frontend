...
describe(`TC-PBI20-BOARD-VISIBILITY-1-FE\n 
    ...
    it(`[Step 2.5] Should no open /board/:id/task/:task-id/edit page and 
        ...
        cy.visit(`/board/${config.kittiwutBoardId}/task/84/edit`) // <------ add your board id and task id here
    ...
    it(`[Step 2.7] Should no open /board/:id/status/:status-id/edit page and 
        ...
        cy.visit(`/board/${config.kittiwutBoardId}/status/192/edit`) // <------ add your board id and status id here
